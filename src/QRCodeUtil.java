...
public class QRCodeUtil {
    ...
    public String decode(String filename) throws Exception {
        return QRCodeUtil.decode(new File("F:\\Work_Space\\JAVA DES\\material\\Gen\\"+filename+".jpg"));
    }


    public void main(String text,String filename,boolean needCompress) throws Exception {
        //不含Logo
        //QRCodeUtil.encode(text, null, "e:\\", true);
        //含Logo，不指定二维码图片名
        //QRCodeUtil.encode(text, "e:\\csdn.jpg", "e:\\", true);
        //含Logo，指定二维码图片
        QRCodeUtil.encode(text, "F:\\Work_Space\\JAVA DES\\material\\mitsuha.jpg", "F:\\Work_Space\\JAVA DES\\material\\Gen", filename, needCompress);
    }
}
